...
export const CARDS: readonly CardProduct[] = [
  ...
  },
  {
    ...
    welcomeBonus: {
      ...
      windowDays: 150,
      introRatePct: 5,
      note: 'Up to GBP125 cashback at 5% in the first five months, no minimum spend. Modelled as 5% of your spend in that window, capped at GBP125; the ordinary 0.5% on that spend is counted as well, so the estimate can be up to GBP12.50 high.',
    },
    fxFeePct: 2.99,
    lounge: null,
    travelInsurance: 'basic',
  ...
  },
  {
    ...
    welcomeBonus: {
      ...
      windowDays: 90,
      introRatePct: 5,
      note: 'Up to GBP125 cashback at 5% in the first three months. Modelled as 5% of your spend in that window, capped at GBP125; the ordinary 0.75% on that spend is counted as well, so the estimate can be up to GBP18.75 high.',
    },
    fxFeePct: 2.99,
    lounge: null,
    travelInsurance: 'basic',
  ...
  },
  {
    ...
    notes: [
      ...
      'The 2.99% FX fee comes from the Barclaycard terms and conditions PDF on barclaycard.co.uk (account usage fees: non-sterling purchase 2.99%); the card page itself does not state it.',
  ...
  },
  {
    ...
    notes: [
      ...
      'The 2.75% FX fee comes from the NatWest credit card fees and charges page on natwest.com (Reward credit card: non-sterling transaction 2.75%); the card page itself gives no percentage.',
  ...
  },
  {
    ...
    notes: [
      ...
      'The Halifax card page and its T&Cs PDF do not publish rates (the PDF is a template with placeholder fields). The 23.9% representative APR comes from the Clarity summary box PDF on halifax.co.uk, which quotes rates from 23.9% to 29.9% APR by circumstances; the 23.94% purchase rate used for interest is the bottom of that range, so a higher personal rate costs more than shown.',
