...
const CATEGORY_ICONS: Record<CategoryName, string> = {
  'Social Media': 'M18 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2zm-3 14H9v-2h6v2zm0-4H9v-2h6v2zm0-4H9V6h6v2z',
...
const OPPORTUNITY_ICONS: Record<string, string> = {
  ...
  novel: 'M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10',
};
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between mt-1 text-xs text-[var(--color-muted)]">
                        ...
                        <span>{Math.max(Math.ceil(average * 2), Math.ceil(inputs.dailyHours * 1.2))}h</span>
                      </div>
                    </div>
