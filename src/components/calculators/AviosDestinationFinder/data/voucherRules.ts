/** BA Amex Companion Voucher rules (2-traveller 2-for-1 only; solo 50% variant not modeled). Doc-only reference, not consumed by code: calculatePartyTotals encodes this directly. Sources: docs/ARCHITECTURE.md. */
