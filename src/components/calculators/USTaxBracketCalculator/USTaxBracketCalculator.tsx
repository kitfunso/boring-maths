        ...
        <div className="p-6 md:p-8">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              ...
              />
              <p className="text-xs text-[var(--color-muted)] mt-1">
                Standard deduction for {FILING_STATUS_LABELS[inputs.filingStatus]}:{' '}
                {formatCurrency(STANDARD_DEDUCTIONS_2025[inputs.filingStatus])}
              </p>
            </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-amber-400 font-medium">
                    You're in the {result.marginalBracketLabel} Tax Bracket
                  </p>
                  <p className="text-sm text-[var(--color-subtle)] mt-1">
                    This doesn't mean all your income is taxed at {result.marginalBracketLabel}.
                    Only income above the bracket threshold is taxed at this rate. Your effective
                    rate of {formatPercent(result.effectiveRate)} is what you actually pay overall.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  {result.bracketBreakdown.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className={`font-medium ${bracketTextColors[item.rate]}`}>
                            {item.rate}% Bracket
                          </p>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-[var(--color-muted)]">
                          Tax: {formatCurrency(item.taxInBracket)}
                        </p>
                      </div>
                    </div>
                  ))}
            ...
            {inputs.deductionType === 'itemized' &&
              inputs.itemizedDeductions < STANDARD_DEDUCTIONS_2025[inputs.filingStatus] && (
                <div className="rounded-xl p-4 border bg-rose-950/30 border-rose-500/30">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--color-subtle)] mt-1">
                        Your itemized deductions ({formatCurrency(inputs.itemizedDeductions)}) are
                        less than the standard deduction (
                        {formatCurrency(STANDARD_DEDUCTIONS_2025[inputs.filingStatus])}). Consider
                        using the standard deduction to lower your tax bill.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white/5 rounded-xl p-4">
              <h4 className="text-sm font-medium text-[var(--color-muted)] mb-3">
                2025 Federal Tax Brackets ({FILING_STATUS_LABELS[inputs.filingStatus]})
              </h4>
              <div className="space-y-2 text-sm text-[var(--color-subtle)]">
                {inputs.filingStatus === 'single' && (
                  <>
                    ...
                    <div className="flex justify-between">
                      <span>12%</span>
                      <span>$11,926 - $48,475</span>
                    </div>
                    <div className="flex justify-between">
                      <span>22%</span>
                      <span>$48,476 - $103,350</span>
                    </div>
                    <div className="flex justify-between">
                      <span>24%</span>
                      <span>$103,351 - $197,300</span>
                    </div>
                    <div className="flex justify-between">
                      <span>32%</span>
                      <span>$197,301 - $250,525</span>
                    </div>
                    <div className="flex justify-between">
                      <span>35%</span>
                      <span>$250,526 - $626,350</span>
                    </div>
                    <div className="flex justify-between">
                      <span>37%</span>
                ...
                {inputs.filingStatus === 'married_jointly' && (
                  <>
                    ...
                    <div className="flex justify-between">
                      <span>12%</span>
                      <span>$23,851 - $96,950</span>
                    </div>
                    <div className="flex justify-between">
                      <span>22%</span>
                      <span>$96,951 - $206,700</span>
                    </div>
                    <div className="flex justify-between">
                      <span>24%</span>
                      <span>$206,701 - $394,600</span>
                    </div>
                    <div className="flex justify-between">
                      <span>32%</span>
                      <span>$394,601 - $501,050</span>
                    </div>
                    <div className="flex justify-between">
                      <span>35%</span>
                      <span>$501,051 - $751,600</span>
                    </div>
                    <div className="flex justify-between">
                      <span>37%</span>
                      <span>Over $751,600</span>
                    </div>
                  </>
                )}
                {inputs.filingStatus === 'married_separately' && (
                  <>
                    ...
                    <div className="flex justify-between">
                      <span>35%</span>
                      <span>$250,526 - $375,800</span>
                    </div>
                    <div className="flex justify-between">
                      <span>37%</span>
                      <span>Over $375,800</span>
                    </div>
                  </>
                )}
                {inputs.filingStatus === 'head_of_household' && (
                  <>
                    ...
                    <div className="flex justify-between">
                      <span>12%</span>
                      <span>$17,001 - $64,850</span>
                    </div>
                    <div className="flex justify-between">
                      <span>22%</span>
                      <span>$64,851 - $103,350</span>
                    </div>
                    <div className="flex justify-between">
                      <span>24%</span>
                      <span>$103,351 - $197,300</span>
                    ...
                    <div className="flex justify-between">
                      <span>32%</span>
                      <span>$197,301 - $250,500</span>
                    </div>
                    <div className="flex justify-between">
                      <span>35%</span>
                      <span>$250,501 - $626,350</span>
                    </div>
                    <div className="flex justify-between">
                      <span>37%</span>
                      <span>Over $626,350</span>
