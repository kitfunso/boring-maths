...
export const EU_COUNTRIES: EUCountry[] = [
  ...
  { code: 'IE', name: 'Ireland', standardRate: 23, reducedRates: [9, 13.5], superReducedRate: 4.8, parkingRate: 13.5 },
  ...
  { code: 'LU', name: 'Luxembourg', standardRate: 17, reducedRates: [8], superReducedRate: 3, parkingRate: 14 },
