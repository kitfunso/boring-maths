...
| 5 | BetaList | [ ] TODO — manual | May have queue. Sign up + submit. |
| 6 | Indie Hackers | [ ] TODO — manual | Community exposure. Sign up + post. |
| 7 | awesome-lifehack-calculators | SKIP | Repo dead (no commits in 6+ years) |
| 8 | Free For Dev | SKIP | Consumer-facing, not dev tooling |
| 9 | There's An App For That | SKIP | Site appears down |

---

## 1. awesome-calculators GitHub PR
...
3. In your fork, click on `README.md` → pencil icon (Edit)
4. Find the **Web** section
...
### Steps
1. Sign up / log in at alternativeto.net
...
### Steps
1. Sign up / log in at saashub.com
2. Go to https://www.saashub.com/submit
3. Fill in:
...
| Pricing | Free |
| Alternative to | Calculator.net, OmniCalculator |
...
2. Go to https://betalist.com/submit
3. Fill in:
...
4. Submit (free tier may have a review queue)
...
3. Fill in product details using the standard copy above
4. Also post in the community — use this as a discussion post:
...
- Tax (US brackets, UK £100k trap, EU VAT, self-employment)
- Health (BMI, TDEE, calories, macros)
- Home (paint, flooring, mulch, electricity cost, solar payback)
- Events (BBQ, wedding alcohol, catering, party drinks)
- Hobbies (brewing, candle making, aquariums, ceramics)

Everything is free, runs client-side, no signup needed.

Site: https://boring-math.com

Would love feedback on what's missing or what could be better.
```
...
Do these in order — each takes about 5 minutes:

1. **awesome-calculators PR** — real GitHub backlink, best SEO value
2. **AlternativeTo** — high-traffic directory, strong domain authority
3. **SaaSHub** — quick win, decent backlink
4. **BetaList** — good for early traction
5. **Indie Hackers** — community + discussion exposure
6. **Product Hunt** — save for a proper launch day (see `docs/product-hunt-launch.md`)
